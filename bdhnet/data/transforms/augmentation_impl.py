...
class Resize(Augmentation):
    ...
    def get_transform(self, image):
        scale = self.shape[0] / image.shape[0]
        return ResizeTransform(image.shape[0], image.shape[1], self.shape[0], self.shape[1], self.interp), scale
...
class ResizeScale(Augmentation):
    ...
    def _get_resize(self, image: np.ndarray, scale: float) -> Transform:
        ...
        return ResizeTransform(input_size[0], input_size[1], output_size[0], output_size[1], self.interp)

    def get_transform(self, image: np.ndarray) -> Transform:
        random_scale = np.random.uniform(self.min_scale, self.max_scale)
        return self._get_resize(image, random_scale), random_scale
...
class FixedSizeCrop(Augmentation):
    ...
    def _get_pad(self, image: np.ndarray) -> Transform:
        ...
        return PadTransform(0, 0, pad_size[1], pad_size[0], original_size[1], original_size[0], self.pad_value)
