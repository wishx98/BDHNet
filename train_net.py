...
from bdhnet import (
    BDHInstanceNewBaselineDatasetMapper,
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        # bdh (coco format)
        if evaluator_type == "bdh_instance_seg" and cfg.MODEL.MASK_FORMER.TEST.INSTANCE_ON:
            evaluator_list.append(BDHCOCOEvaluator(dataset_name, output_dir=output_folder))
    ...
    # TODO: add new dataset mapper
    @classmethod
    def build_train_loader(cls, cfg):
        # bdh (coco format) instance segmentation swx new baseline
        if cfg.INPUT.DATASET_MAPPER_NAME == "bdh_instance_swx":
            mapper = BDHInstanceNewBaselineDatasetMapper(cfg, True)
    ...
    # TODO: add new dataset mapper
    @classmethod
    def build_test_loader(cls, cfg, dataname):
        if cfg.INPUT.DATASET_MAPPER_NAME == "bdh_instance_swx":
            mapper = BDHInstanceNewBaselineDatasetMapper(cfg, False)
